...
Each task is stored in a plain-text file following a consistent structure. These files can be generated or edited manually and are designed for readability and version control.
