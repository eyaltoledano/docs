---
title: "Task Master Tutorial"
description: "This tutorial will guide you through setting up and using Task Master for AI-driven development."
---
...
1. Place your PRD document in the `scripts/` directory (e.g., `scripts/prd.txt`)
2. **Use natural language commands** to interact with Task Master:
